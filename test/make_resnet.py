...
def main():
    ...
    symbol.save("resnet50_alternative.json")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data-dir', type=str, default='../cifar10/', help='the input data directory')
    parser.add_argument('--data-type', type=str, default='cifar10', help='the dataset type')
    ...
    parser.add_argument('--num-classes', type=int, default=10, help='the class number of your task')
